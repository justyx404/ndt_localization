...
private:
  ...
  double initialization_confirmation_reserve_ms_;
  double initialization_stddev_multiplier_;
  double initialization_minimum_translation_span_m_;
  double initialization_maximum_translation_span_m_;
  double initialization_minimum_yaw_span_deg_;
  double initialization_maximum_yaw_span_deg_;
  double recovery_translation_span_m_;
  double recovery_yaw_span_deg_;
  double relocalization_retry_delay_ms_;
  int initialization_maximum_hypotheses_;
  double initialization_coarse_map_leaf_size_m_;
  double initialization_coarse_scan_leaf_size_m_;
  int initialization_maximum_coarse_scan_points_;
  double initialization_coarse_resolution_m_;
  double initialization_coarse_step_size_m_;
  double initialization_coarse_transformation_epsilon_;
  int initialization_coarse_maximum_iterations_;
  int initialization_refinement_candidates_;
  double initialization_refinement_reserve_ms_;
  double initialization_fitness_max_range_m_;
  double initialization_maximum_fitness_score_;
  double initialization_minimum_score_margin_;
  double initialization_distinct_translation_m_;
  double initialization_distinct_rotation_deg_;
